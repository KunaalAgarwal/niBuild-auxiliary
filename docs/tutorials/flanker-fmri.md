...
3. Drag the **BIDS Dataset** item onto the canvas. A file picker dialog will appear.
...
1. Double-click the workspace tab and rename it `flanker_analysis` (or any name you prefer) — the export filename is taken from the workspace name.
